...
@section('content')
    <div class="container-fluid page-header py-5">
        <h1 class="text-center text-white display-6">Pesan Kamar</h1>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        <th scope="row">
                                            <div class="d-flex align-items-center mt-2">
                                                <img src="fruitables/img/vegetable-item-2.jpg"
                                    ...
                                    <tr>
                                        <th scope="row">
                                            <div class="d-flex align-items-center mt-2">
                                                <img src="fruitables/img/vegetable-item-5.jpg"
                                                    class="img-fluid rounded-circle" style="width: 90px; height: 90px;"
                                                    alt="">
                                            </div>
                                        </th>
                                    ...
                                    <tr>
                                        <th scope="row">
                                            <div class="d-flex align-items-center mt-2">
                                                <img src="fruitables/img/vegetable-item-3.png"
                                                    class="img-fluid rounded-circle" style="width: 90px; height: 90px;"
                                                    alt="">
                                            </div>
                                        </th>
