...
@section('content')
    <div class="container">
        ...
        @can('kategori_pengeluaran-create')
                        ...
                        @foreach ($kategoriPengeluarans as $kategori)
                            <tr class="text-center">
                                ...
                                <td>
                                    ...
                                    @can('kategori_pengeluaran-edit')
                                        <a href="{{ route('kategori_pengeluarans.edit', $kategori->id) }}"
                                            class="btn btn-warning btn-sm">Edit</a>
                                    @endcan
                                    @can('kategori_pengeluaran-delete')
                                        <form action="{{ route('kategori_pengeluarans.destroy', $kategori->id) }}"
